//package br.com.itau.cartaodecreditoAPI.cartaodecreditoAPI.propostas;
//
...
//import br.com.itau.cartaodecreditoAPI.cartaodecreditoAPI.controllers.proposta.NovaPropostaController;
...
//		NovaPropostaController controller = new NovaPropostaController(manager, validadorDocumento, null);
//		NovaPropostaForm request = new NovaPropostaForm("email@eamil.com", "Alberto", "endereco",
//				new BigDecimal("1000"), "111111111");
//		UriComponentsBuilder builder = UriComponentsBuilder.newInstance();
//
//		Assertions.assertThrows(ResponseStatusException.class, () -> {
//			controller.criaProposta(request, builder,"");
//		});
//	}
//
//	@Test
...
//
//		/*
//		 * O Mockito verifica se o objeto que representa a request de nova proposta que
//		 * vai ser passado como argumento lá dentro do método cria é de fato o mesmo
//		 * objeto que está sendo esperando na definicao da expectativa
//		 */
//		Mockito.when(validadorDocumento.estaValido(request)).thenReturn(true);
//		ResponseEntity<?> response = controller.criaProposta(request, builder,"");
//
